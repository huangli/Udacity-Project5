...
features_list = ['poi', 'total_payments', 'loan_advances',
 'restricted_stock_deferred', 'expenses', 'long_term_incentive', 'from_this_person_to_poi']
 # add whether_email_to_poi
my_features_list = ['poi', 'total_payments', 'loan_advances',
 'restricted_stock_deferred', 'expenses', 'long_term_incentive', 'whether_email_to_poi']
